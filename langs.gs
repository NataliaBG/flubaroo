...
// START BULGARIAN ////////////////////////////////////////////////////////////////////////////////
    ...
    "bg-BG": {
        ...
        // Message shown when grading is complete (1 of 2).
        "FLB_STR_RESULTS_MSG1" : "Създаден е нов работен лист Оценки. Той съдържа оценка за всеки изпратен тест, както и обобщение за всички проведени тестове в горната част.\
                                  Последният ред показва процента на учениците, който са отговорили на въпроса правилно, като въпросите с най-много грешни отговори са оцветени в оранжево.\
